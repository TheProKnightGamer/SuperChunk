package dev.superchunk.net.caffeinemc.mods.lithium.mixin.ai.poi;

import com.mojang.serialization.Codec;
import dev.superchunk.net.caffeinemc.mods.lithium.common.util.Distances;
import dev.superchunk.net.caffeinemc.mods.lithium.common.world.interests.PointOfInterestSetExtended;
import dev.superchunk.net.caffeinemc.mods.lithium.common.world.interests.PointOfInterestStorageExtended;
import dev.superchunk.net.caffeinemc.mods.lithium.common.world.interests.RegionBasedStorageSectionExtended;
import dev.superchunk.net.caffeinemc.mods.lithium.common.world.interests.iterator.NearbyPointOfInterestStream;
import dev.superchunk.net.caffeinemc.mods.lithium.common.world.interests.iterator.SinglePointOfInterestTypeFilter;
import dev.superchunk.net.caffeinemc.mods.lithium.common.world.interests.iterator.SphereChunkOrderedPoiSetSpliterator;
