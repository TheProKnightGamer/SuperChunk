...
import dev.superchunk.com.ishland.c2me.opts.dfc.common.ducks.IEqualityOverriding;
...
// Yarn DensityFunctionTypes.Wrapping (the cache marker) -> Mojmap DensityFunctions$Marker
// (a record implementing MarkerOrMarked).
@Mixin(DensityFunctions.Marker.class)
public abstract class MixinDFTWrapping implements IFastCacheLike, IEqualityOverriding, DensityFunctions.MarkerOrMarked {
