...
public class ShiftedNoiseNode implements AstNode {
    ...
    public ShiftedNoiseNode(AstNode shiftX, AstNode shiftY, AstNode shiftZ, double xzScale, double yScale, NoiseHolder noise) {
    ...
    public void doBytecodeGenSingle(BytecodeGen.Context context, InstructionAdapter m, BytecodeGen.Context.LocalVarConsumer localVarConsumer) {
        String noiseField = context.newField(NoiseHolder.class, this.noise);
        ...
        m.getfield(context.className, noiseField, Type.getDescriptor(NoiseHolder.class));
