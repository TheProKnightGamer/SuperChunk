...
import dev.superchunk.com.ishland.c2me.fixes.worldgen.threading_issues.common.debug.SMAPSourceDebugExtension;
...
public class CheckedThreadLocalRandom extends LegacyRandomSource {

    private static final Logger LOGGER = LoggerFactory.getLogger("CheckedThreadLocalRandom");

    private static final ThreadLocal<LegacyRandomSource> FALLBACK = ThreadLocal.withInitial(() -> new LegacyRandomSource(new Random().nextLong()));
