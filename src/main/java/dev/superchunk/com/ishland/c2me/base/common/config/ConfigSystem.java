...
import dev.superchunk.com.ishland.c2me.base.common.util.BooleanUtils;
...
public class ConfigSystem {
    ...
    public static class ConfigAccessor {
        ...
        public ConfigAccessor incompatibleMod(String modId, String predicate) {
            try {
                ...
                if (optional.isPresent()) {
                    final ModInfo modInfo = optional.get();
        ...
        private void findModDefinedIncompatibility() {
            // TODO: NeoForge has no direct equivalent of Fabric custom mod metadata values.
...
//            }
        ...
        private void disableConfigWithReason(String reason) {
            ...
            // relocation mechanically renamed this user-facing -D switch).
            if (!Boolean.getBoolean("dev.superchunk.com.ishland.c2me.base.config.ignoreIncompatibility")
                    && !Boolean.getBoolean("com.ishland.c2me.base.config.ignoreIncompatibility")) {
